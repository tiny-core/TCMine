...
///     <list type="bullet">
///         <item>
///             <b>Produção (Linux/Docker)</b> → symlinks reais (arquivo e pasta): instantâneo, custo zero
///             de disco. 500+ mods viram 500 ponteiros.
///         </item>
///         <item>
///             <b>Dev (Windows)</b> → symlink no Windows exige admin/Developer Mode; então caímos para
///             hardlink de arquivo (funciona sem privilégio, mesma partição) e cópia recursiva de pasta.
///         </item>
///     </list>
