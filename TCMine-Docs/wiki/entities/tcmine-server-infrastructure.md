---
type: entity
title: TCMine-Server.Infrastructure
tags: [entity, tcmine, infrastructure, ef-core, curseforge]
status: wip
created: 2026-06-23
updated: 2026-07-01
aliases: [TCMine-Server.Infrastructure, TCMine-Infrastructure, Infrastructure, Infra]
sources:
...
`TCMine-Server.Infrastructure` (namespace `TCMine_Server.Infrastructure`) é a camada externa
...
- Código: `TCMine-Server.Infrastructure/Persistence/`, `CurseForge/`, `FileSystem/`,
