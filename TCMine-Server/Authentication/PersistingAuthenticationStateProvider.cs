...
///     <list type="bullet">
///         <item>
///             No <b>prerender</b> (dentro do HttpContext) lê o <c>HttpContext.User</c> e o
///             persiste via <see cref="PersistentComponentState" />;
///         </item>
///         <item>
///             No <b>circuito interativo</b> (onde já não há HttpContext) restaura a identidade
///             a partir do estado persistido — assim <c>&lt;AuthorizeView&gt;</c> funciona nas páginas
///             interativas (Dashboard, Configurações).
///         </item>
///     </list>
...
public sealed class PersistingAuthenticationStateProvider : AuthenticationStateProvider, IDisposable
{
    ...
    ///     que persiste o estado de autenticação em pre-renderização do servidor e circuitos interativos em aplicativos Blazor
    ///     Server.
    /// </summary>
    ...
    /// </summary>
    /// <returns>
    ///     Uma <see cref="Task{TResult}" /> representando a operação assíncrona,
