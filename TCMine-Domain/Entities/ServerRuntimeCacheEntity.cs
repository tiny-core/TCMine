...
///     <para>
///         <b>Por que existe (economia de disco):</b> uma instalação de NeoForge/Forge traz um
...
///         habilita GC por LRU (<see cref="LastUsedAt" />) das instalações que nenhuma instância usa mais.
///     </para>
///     <para>
///         Espelha a política do cache de jars de mods (<see cref="ModFileEntity" /> +
///         <c>tcmine-data/mods</c>): conteúdo compartilhado no disco, dedup por identidade.
///     </para>
/// </summary>
