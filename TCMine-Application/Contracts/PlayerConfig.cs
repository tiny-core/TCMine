...
/// <summary>
/// Manifesto das configs player-owned de um <c>(uuid, modpackId)</c>: mapeia cada ficheiro (caminho
/// relativo à pasta do jogo, com '/') ao seu hash e tamanho. É a base do <b>sync incremental</b>
/// ([[concepts/player-config-sync]]): comparando manifestos, só os ficheiros que mudaram trafegam,
/// em vez do zip inteiro. O servidor guarda-o como <c>.tcmine-manifest.json</c> ao lado dos ficheiros;
...
/// <summary>Hash (SHA-256, hex) e tamanho de um ficheiro no manifesto.</summary>
