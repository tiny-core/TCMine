...
/// </summary>
public abstract record CfManifestLoaderDto(string Id, bool Primary);
...
/// </summary>
public abstract record CfManifestMcDto(string Version, List<CfManifestLoaderDto> ModLoaders);
...
/// </summary>
public abstract record CfManifestFileDto(
